...
fun VersionCatalogBuilder.voice() {
    version("lavaplayer", "8ca9418be9")

    library("lavaplayer",            "com.github.topi314.lavaplayer-fork", "lavaplayer").versionRef("lavaplayer")
    library("lavaplayer-ip-rotator", "com.github.topi314.lavaplayer-fork", "lavaplayer-ext-youtube-rotator").versionRef("lavaplayer")
